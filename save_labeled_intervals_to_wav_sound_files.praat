...
#
# Modified to save text grid sections as well
...
form Save intervals to small WAV sound files
	...
	sentence Folder C:\Users\Patrick\Documents\audio\2012interviews\working\
	...
	sentence Suffix 
	comment Give the folder where to save the textgrids:
	sentence Folder C:\Users\Patrick\Documents\audio\2012interviews\working\
endform
...
for interval from start_from to end_at
	...
	if check = 0
		...
		tgfile$ = "'folder$'" + "'prefix$'" + "'filename$'" + "'suffix$''indexnumber'" + ".TextGrid"
		select TextGrid 'gridname$'
		Extract part... 'intervalstart' 'intervalend' no	
